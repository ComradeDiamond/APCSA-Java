...
public class Picture extends SimplePicture {
  ...
  public void mirrorHorizontal() {
    ...
    for (int col = 0; col < width; col++) {
      for (int row = 0; row < pixels.length / 2; row++) {
        left = pixels[row][col];
        right = pixels[pixels.length - 1 - row][col];
  ...
  /**
   * Mirror horizontally from bottom to top
   */
  ...
  public void mirrorArms() {
    ...
    for (int col = 0; col < pixels[0].length; col++) {
      for (int row = 160; row < mirrorPoint; row++) {
        leftPixel = pixels[row][col];
        rightPixel = pixels[mirrorPoint + (mirrorPoint - row)][col];
        rightPixel.setColor(leftPixel.getColor());
      }
    }
  }
  ...
  /**
   * Copies a portion of the picture
   * @param fromPic The picture to copy
   * @param startFromRow The row to start copying picture
   * @param endRow The row to stop copying picture
   * @param startFromCol The column to start copying from
   * @param endCol The column to end copying from
   * @param startToRow The row to start printing
   * @param startToCol The column to start printing
   */
  ...
  {
    Picture flower1 = new Picture("flower1.jpg");
    this.copy(flower1, 20, 80);

    Picture snowman = new Picture("snowman.jpg");
    this.copy(snowman, 200, 350);

    Picture butterfly1 = new Picture("butterfly1.jpg");
    this.copy(butterfly1, 0, 70, 0, 200, 0, 150);
  }
