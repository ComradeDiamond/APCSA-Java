public class Student {
    ...
    //Add a constructor with no parameters to initialize both name and email to "missing"
    public Student()
    {
        name = "missing";
        email = "missing";
    ...
    //The constructor for creating a Student object with the name and email as parameters
