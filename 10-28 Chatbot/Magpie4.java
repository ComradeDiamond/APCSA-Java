...
public class Magpie4 {
    ...
    private String transformIWantStatement(String statement) {
        String x = statement.substring(statement.indexOf("I want ") + 7 );
    ...
    private String transformIMeStatement(String statement) {
        String y = statement.substring(statement.indexOf("I ")+2, statement.indexOf("you"));
        return "Why do you " + y + " me?";
    }
    ...
    public static void main(String[] args) {
        ...
        String statement = "I want to food.";
